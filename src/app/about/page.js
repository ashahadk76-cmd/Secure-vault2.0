      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            ...
            No technical Knowledge required it - just peace of mind Ashahad khan .
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 mb-16 md:mb-20">
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              ...
              We believe everyone deserves to browse the internet without security worries.ashahad
            </p>
          </div>
